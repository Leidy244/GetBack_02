...
public class MeseroController {
    ...
    public String mesasMenu(@RequestParam(name = "mesa", required = false, defaultValue = "1") Integer mesaId, Model model) {
        try {
            var categorias = categoriaService.findAll();
            var productos = menuService.findAll(); // Cambiado de listarDisponibles() a findAll()
    ...
    public String crearPedido(@RequestParam Integer mesaId,
    ...
    private Map<String, Object> procesarItemsPedido(String comentario) {
        ...
        // Lógica de procesamiento del JSON iría aquí
        return result;
    }
}